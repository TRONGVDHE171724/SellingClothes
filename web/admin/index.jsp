<%-- 
    Document   : index
    Created on : Mar 1, 2024, 11:22:48 PM
    Author     : Trong
--%>
...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="admin/images/Trong.jpg" width="50px"
                                                alt="User Image">
                <div>
                        ...
                        <div class="col-md-6">
                            <div class="widget-small primary coloured-icon"><i class='icon bx bxs-user-account fa-3x'></i>
                                <div class="info">
                                    ...
                                    <p><b>${requestScope.user + 2}  khách hàng</b></p>
