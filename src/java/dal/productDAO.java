...
public class productDAO {
    ...
    public List<Product> getProduct() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(new Product(c, rs.getString(2), rs.getString(3), rs.getInt(4), rs.getString(5), rs.getInt(6), rs.getString(7)));
            }
    ...
    public List<Product> getTop10Product() {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new Product(rs.getString(1), rs.getString(2), rs.getInt(3), rs.getString(4), rs.getInt(5), rs.getString(6)));
            }
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    public Product getProductByID(String product_id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                return (new Product(c, rs.getString(3), rs.getString(4), rs.getInt(5), rs.getString(6), rs.getInt(7), rs.getString(8)));
            }
        } catch (Exception e) {
            System.out.println(e);
        }
