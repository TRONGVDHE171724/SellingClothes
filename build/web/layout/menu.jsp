...
<div class="offcanvas_menu">
    ...
    <div class="offcanvas_menu_wrapper">
        ...
        <div class="offcanvas_footer">
            <span><a href="#"><i class="fa fa-envelope-o"></i> trong10403@gmail.com</a></span>
            <ul>
        ...
        <div class="container-fluid">   
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-12">
                    <div class="welcome_text">
                        <ul>
                            <li><span>Giao hàng miễn phí: &nbsp</span>Hãy tận dụng thời gian của chúng tôi để lưu lại sự kiện </li>
                            <li><span>Trả hàng miễn phí: &nbsp</span> Đảm bảo sự hài lòng</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="middel_inner">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="logo">
                            <a href="home"><img src="assets/img/logo/T_CLOTHES_LOGO.png" alt="" style="width: 25%; height: auto;"></a>
                        </div>
                    </div>
