                        ...
                        <div class="tile-body">
                            ...
                            <form class="row" action="productmanager?action=insertproduct" method="POST" >
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" value="" name="product_id" type="text" placeholder="">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" value="" name="product_name" type="text">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Giá bán</label>
                                    <input class="form-control" value="" name="price" type="number">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Size</label>
                                    <input class="form-control" value="" name="size" type="text" placeholder="S,L,XL,...">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Màu</label>
                                    <input class="form-control" value="" placeholder="Blue,Gray,..." name="color" type="text">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Số lượng</label>
                                    <input class="form-control" value="" name="quantity" type="number">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" value="" name="describe" id="describe"></textarea>
                                </div>
