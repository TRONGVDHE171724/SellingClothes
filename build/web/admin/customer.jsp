<%-- 
    Document   : customer
    Created on : Mar 1, 2024, 11:20:59 PM
    Author     : Trong
--%>
...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
                                ...
                                <tbody>
                                    <c:forEach items="${user}" var="u">
                                        <tr>
                                            ...
                                            <td>${u.user_email}</td>
                                            <td>${u.isAdmin}</td>
                                            <td><button class="btn btn-primary btn-sm edit" type="button" title="Sửa" data-toggle="modal" data-target="#ModalUP${u.user_id}">
        ...
        </c:forEach>        <!-- Essential javascripts for application to work-->
