<%-- 
    Document   : index
    Created on : Mar 1, 2024, 8:28:36 AM
    Author     : Trong
--%>
                                ...
                                <div class="col-lg-3">
                                    <div class="single_product">
                                        <div class="product_thumb">
                                            ...
                                            <a class="primary_img" href="product?action=productdetail&product_id=${td.product_id}"><img src="${td.img}" alt=""></a>
                                            <div class="quick_button">
                                                <!-- Update the href attribute here -->
                                                <a href="/product/${td.product_id}" title="quick_view">Xem sản phẩm</a>
                                            </div>
                                        </div>
                                        <div class="product_content">
                                            <!-- Update the href attribute here -->
                                            <h3><a href="/product/${td.product_id}">${td.product_name}</a></h3>
